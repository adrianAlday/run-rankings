        ...
        <div id="filters" className="my-8">
          <div className="my-2 flex flex-wrap">
            {priceOptions.map((priceOption, index) => (
              <div
                ...
                className={`mr-2 my-1 border border-[rgb(52,53,54)] hover:border-[rgb(74,119,145)] rounded-md ${price === priceOption ? "bg-[rgb(36,50,59)]" : "bg-[rgb(29,30,31)]"} py-1 px-2 shrink-0 flex items-center justify-center text-xs font-medium transition-all duration-700 transition-discrete`}
              >
          ...
          <div className="my-2 flex flex-wrap">
            {typeOptions.map((typeOption) => (
              <div
                ...
                className={`mr-2 my-1 border border-[rgb(52,53,54)] hover:border-[rgb(74,119,145)] rounded-md ${type === typeOption ? "bg-[rgb(36,50,59)]" : "bg-[rgb(29,30,31)]"} py-1 px-2 shrink-0 flex items-center justify-center text-xs font-medium transition-all duration-700 transition-discrete`}
              >
          ...
          <div className="my-4">
            <input
              ...
              className={`border border-[rgb(52,53,54)] focus:border-[rgb(74,119,145)] rounded-md w-full ${find ? "bg-[rgb(36,50,59)]" : "bg-[rgb(29,30,31)]"} py-1 px-2 text-md font-semibold transition-all duration-700 transition-discrete`}
              placeholder="Find"
            />
          </div>
        </div>
